...
impl CryptoPolicyEngine {
    ...
    pub fn recommend_scheme(use_case: &UseCase, config: &CoreConfig) -> Result<String> {
        ...
        match *use_case {
            // Encryption use cases - always hybrid
            ...
            // Signature use cases - hybrid (ML-DSA + Ed25519)
            ...
            // Homomorphic use cases require enterprise features
            // Fallback to hybrid encryption for API compatibility
