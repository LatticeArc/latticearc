...
//!
//! All types are defined in [`arc_types::key_lifecycle`] and re-exported here.
//! The `transition()` method returns [`arc_types::TypeError`]; use
...
pub use arc_types::key_lifecycle::*;
