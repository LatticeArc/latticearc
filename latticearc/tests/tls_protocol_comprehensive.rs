...
mod handshake_tests {
    ...
    #[test]
    fn test_pq_tls13_handshake_config_hybrid_mode_succeeds() {
    ...
    #[test]
    fn test_pq_tls13_handshake_config_pq_only_mode_succeeds() {
    ...
    #[test]
    fn test_pq_tls13_key_exchange_info_mlkem768_succeeds() {
    ...
    #[test]
    fn test_pq_tls13_provider_availability_succeeds() {
    ...
    #[test]
    fn test_pq_tls13_handshake_states_succeeds() {
    ...
    #[test]
    fn test_pq_tls13_handshake_stats_default_succeeds() {
    ...
    #[test]
    fn test_certificate_chain_validation_no_file_succeeds() {
    ...
    #[test]
    fn test_certificate_chain_validation_invalid_pem_fails() {
    ...
    #[test]
    fn test_session_resumption_config_default_succeeds() {
    ...
    #[test]
    fn test_configurable_session_store_succeeds() {
        let store = ConfigurableSessionStore::new(100);
        assert_eq!(store.capacity(), 100);
    }

    #[test]
    fn test_persistent_session_store_succeeds() {
    ...
    #[test]
    fn test_client_auth_config_creation_succeeds() {
    ...
    #[test]
    fn test_client_verification_mode_none_succeeds() {
        let mode = ClientVerificationMode::None;
        assert_eq!(mode, ClientVerificationMode::default());
    }

    #[test]
    fn test_client_verification_mode_optional_succeeds() {
    ...
    #[test]
    fn test_client_verification_mode_required_succeeds() {
    ...
    #[test]
    fn test_mtls_client_auth_config_succeeds() {
    ...
    #[test]
    fn test_mtls_server_ca_certs_config_succeeds() {
        let config = TlsConfig::new()
    ...
    #[tokio::test]
    async fn test_handshake_failure_invalid_domain_fails() {
    ...
    #[tokio::test]
    async fn test_handshake_failure_empty_domain_name_fails() {
        let config = TlsConfig::default();
    ...
    #[test]
    fn test_handshake_failure_invalid_protocol_version_range_fails() {
    ...
    #[test]
    fn test_handshake_early_data_validation_succeeds() {
    ...
    #[test]
    fn test_handshake_early_data_valid_succeeds() {
...
mod cipher_suite_tests {
    ...
    #[test]
    fn test_cipher_suite_aes_256_gcm_sha384_classic_succeeds() {
    ...
    #[test]
    fn test_cipher_suite_aes_256_gcm_sha384_hybrid_succeeds() {
    ...
    #[test]
    fn test_cipher_suite_chacha20_poly1305_classic_succeeds() {
        let suites = get_cipher_suites(TlsMode::Classic);
    ...
    #[test]
    fn test_cipher_suite_chacha20_poly1305_hybrid_succeeds() {
        let suites = get_cipher_suites(TlsMode::Hybrid);
    ...
    #[test]
    fn test_cipher_suite_chacha20_poly1305_pq_succeeds() {
    ...
    #[test]
    fn test_hybrid_cipher_suite_negotiation_scheme_512_succeeds() {
        assert_eq!(HYBRID_TLS_512, "hybrid-x25519-ml-kem-512");
    }

    #[test]
    fn test_hybrid_cipher_suite_negotiation_scheme_768_succeeds() {
        assert_eq!(HYBRID_TLS_768, "hybrid-x25519-ml-kem-768");
    }

    #[test]
    fn test_hybrid_cipher_suite_negotiation_scheme_1024_succeeds() {
        assert_eq!(HYBRID_TLS_1024, "hybrid-x25519-ml-kem-1024");
    }

    #[test]
    fn test_hybrid_cipher_suite_default_scheme_succeeds() {
        assert_eq!(DEFAULT_TLS_SCHEME, "hybrid-x25519-ml-kem-768");
        assert_eq!(DEFAULT_TLS_KEX, "X25519MLKEM768");
    }

    #[test]
    fn test_pq_only_cipher_suite_schemes_succeeds() {
    ...
    #[test]
    fn test_classical_cipher_suite_scheme_succeeds() {
        assert_eq!(CLASSICAL_TLS_KEX, "X25519");
        assert_eq!(CLASSICAL_TLS_SCHEME, "classic-x25519");
    }

    #[test]
    fn test_secure_cipher_suites_validation_succeeds() {
    ...
    #[test]
    fn test_cipher_suite_selection_by_security_level_succeeds() {
        // Standard -> ML-KEM-512
    ...
    #[test]
    fn test_kex_algorithm_selection_succeeds() {
        assert_eq!(
...
mod certificate_tests {
    ...
    #[test]
    fn test_ml_dsa_certificate_config_pq_mode_succeeds() {
    ...
    #[test]
    fn test_ml_dsa_certificate_use_case_government_succeeds() {
    ...
    #[test]
    fn test_certificate_chain_pq_config_succeeds() {
        let config = Tls13Config::pq();
    ...
    #[test]
    fn test_certificate_chain_hybrid_config_succeeds() {
        let config = Tls13Config::hybrid();
        assert!(config.use_pq_kx);
        assert_eq!(config.mode, TlsMode::Hybrid);
    }
    ...
    #[test]
    fn test_self_signed_cert_error_code_fails() {
    ...
    #[test]
    fn test_certificate_error_codes_fails() {
...
mod error_handling_tests {
    ...
    #[test]
    fn test_invalid_certificate_rejection_missing_file_fails() {
    ...
    #[test]
    fn test_invalid_private_key_rejection_missing_file_fails() {
    ...
    #[test]
    fn test_invalid_private_key_rejection_invalid_pem_fails() {
        let mut temp_file = NamedTempFile::new().unwrap();
    ...
    #[test]
    fn test_expired_certificate_error_code_fails() {
        let code = ErrorCode::CertificateExpired;
        assert_eq!(format!("{}", code), "CERTIFICATE_EXPIRED");
    }

    #[test]
    fn test_certificate_not_yet_valid_error_code_fails() {
    ...
    #[test]
    fn test_signature_verification_failed_error_fails() {
        let code = ErrorCode::SignatureVerificationFailed;
        assert_eq!(format!("{}", code), "SIGNATURE_VERIFICATION_FAILED");
    }

    #[test]
    fn test_certificate_signature_invalid_recovery_fails() {
    ...
    #[test]
    fn test_recovery_hint_retry_succeeds() {
    ...
    #[test]
    fn test_recovery_hint_fallback_succeeds() {
    ...
    #[test]
    fn test_recovery_hint_reconfigure_succeeds() {
    ...
    #[test]
    fn test_retry_policy_backoff_exponential_succeeds() {
        let policy = RetryPolicy::default();
    ...
    #[test]
    fn test_circuit_breaker_opens_after_threshold_succeeds() {
        let breaker = CircuitBreaker::new(3, Duration::from_secs(60));
    ...
    #[test]
    fn test_fallback_strategy_none_succeeds() {
    ...
    #[test]
    fn test_fallback_strategy_custom_succeeds() {
...
mod tls_mode_tests {
    ...
    #[test]
    fn test_tls_config_new_default_succeeds() {
        let config = TlsConfig::new();
        assert_eq!(config.mode, TlsMode::Hybrid);
        assert!(config.enable_fallback);
        assert!(config.enable_resumption);
    ...
    #[test]
    fn test_tls_config_use_case_webserver_succeeds() {
        let config = TlsConfig::new().use_case(TlsUseCase::WebServer);
        assert_eq!(config.mode, TlsMode::Hybrid);
    }

    #[test]
    fn test_tls_config_use_case_iot_succeeds() {
        let config = TlsConfig::new().use_case(TlsUseCase::IoT);
        assert_eq!(config.mode, TlsMode::Classic);
    }

    #[test]
    fn test_tls_config_use_case_government_succeeds() {
        let config = TlsConfig::new().use_case(TlsUseCase::Government);
        assert_eq!(config.mode, TlsMode::Pq);
    }

    #[test]
    fn test_tls_config_security_level_quantum_succeeds() {
        let config = TlsConfig::new().security_level(SecurityLevel::Quantum);
        assert_eq!(config.mode, TlsMode::Pq);
    }

    #[test]
    fn test_tls_config_security_level_maximum_succeeds() {
    ...
    #[test]
    fn test_tls_use_case_all_succeeds() {
        let all = TlsUseCase::all();
        assert_eq!(all.len(), 10);
    }

    #[test]
    fn test_tls_use_case_descriptions_is_documented() {
    ...
    #[test]
    fn test_policy_engine_create_config_succeeds() {
    ...
    #[test]
    fn test_policy_engine_select_balanced_succeeds() {
...
mod config_builder_tests {
    ...
    #[test]
    fn test_config_builder_chain_succeeds() {
        let config = TlsConfig::new()
    ...
    #[test]
    fn test_config_builder_alpn_protocols_succeeds() {
    ...
    #[test]
    fn test_config_builder_max_fragment_size_has_correct_size() {
    ...
    #[test]
    fn test_config_builder_early_data_succeeds() {
    ...
    #[test]
    fn test_config_builder_retry_policy_succeeds() {
        let policy = RetryPolicy::conservative();
    ...
    #[test]
    fn test_config_builder_key_logging_succeeds() {
    ...
    #[test]
    fn test_config_builder_protocol_versions_succeeds() {
        let config = TlsConfig::new()
            .with_min_protocol_version(ProtocolVersion::TLSv1_3)
    ...
    #[test]
    fn test_tls13_config_builder_chain_succeeds() {
        let config = Tls13Config::hybrid()
    ...
    #[test]
    fn test_config_validation_success_succeeds() {
        let config = TlsConfig::new();
...
mod version_feature_tests {
    ...
    #[test]
    fn test_version_not_empty_succeeds() {
    ...
    #[test]
    fn test_custom_hybrid_available_succeeds() {
        assert!(is_custom_hybrid_available());
    }

    #[test]
    fn test_pq_available_succeeds() {
        assert!(is_pq_available());
    }

    #[test]
    fn test_config_info_classic_succeeds() {
        let config = TlsConfig::new().use_case(TlsUseCase::IoT);
    ...
    #[test]
    fn test_config_info_hybrid_succeeds() {
        let config = TlsConfig::new();
        let info = get_config_info(&config);
    ...
    #[test]
    fn test_config_info_pq_succeeds() {
        let config = TlsConfig::new().security_level(SecurityLevel::Quantum);
        let info = get_config_info(&config);
...
mod kex_info_tests {
    ...
    #[test]
    fn test_kex_info_hybrid_rustls_pq_succeeds() {
        let info = get_kex_info(TlsMode::Hybrid, PqKexMode::RustlsPq);
        assert_eq!(info.method, "X25519MLKEM768");
        assert!(info.is_pq_secure);
    ...
    #[test]
    fn test_kex_provider_classical_succeeds() {
        let provider = get_kex_provider(TlsMode::Classic, PqKexMode::Classical);
        assert!(provider.is_ok());
    }

    #[test]
    fn test_kex_provider_hybrid_succeeds() {
        let provider = get_kex_provider(TlsMode::Hybrid, PqKexMode::RustlsPq);
        assert!(provider.is_ok());
    }

    #[test]
    fn test_kex_provider_pq_succeeds() {
