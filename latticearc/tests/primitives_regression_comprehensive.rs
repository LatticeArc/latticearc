// This test file exercises non-FIPS algorithms (ChaCha20-Poly1305, Ed25519, etc.).
...
fn regression_sha512_block_boundary() {
    use latticearc::primitives::hash::sha512;
...
fn regression_ml_kem_shared_secret_length() {
    use latticearc::primitives::kem::ml_kem::MlKemSharedSecret;
...
fn regression_ml_kem_ciphertext_size_mismatch() {
    use latticearc::primitives::kem::ml_kem::{MlKemCiphertext, MlKemSecurityLevel};
...
fn regression_hash_nonzero_output() {
    use latticearc::primitives::hash::{sha256, sha384, sha512};
...
#[test]
fn kat_sha384_empty() {
    use latticearc::primitives::hash::sha384;
...
fn key_derivation_consistency() {
    use latticearc::primitives::kdf::hkdf_extract;
...
fn error_aead_invalid_key_type() {
    use latticearc::primitives::aead::{AeadCipher, AeadError, aes_gcm::AesGcm128};
...
fn error_ml_kem_wrong_key_size() {
    use latticearc::primitives::kem::ml_kem::{MlKemPublicKey, MlKemSecurityLevel};
