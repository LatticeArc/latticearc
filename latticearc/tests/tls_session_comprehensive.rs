...
use latticearc::tls::{
    ClientVerificationMode, SessionPersistenceConfig, TlsConfig, TlsError, TlsMode,
};
...
mod session_management {
    ...
    #[test]
    fn test_session_creation_default_capacity_succeeds() {
        let store = ConfigurableSessionStore::new(100);
        assert_eq!(store.capacity(), 100);
    }

    #[test]
    fn test_session_creation_large_capacity_succeeds() {
        let store = ConfigurableSessionStore::new(10000);
        assert_eq!(store.capacity(), 10000);
    }

    #[test]
    fn test_session_creation_minimum_capacity_succeeds() {
        let store = ConfigurableSessionStore::new(1);
        assert_eq!(store.capacity(), 1);
    }

    #[test]
    fn test_session_store_arc_reference_succeeds() {
    ...
    #[test]
    fn test_persistent_store_persistence_disabled_succeeds() {
    ...
    #[test]
    fn test_create_session_store_none_config_succeeds() {
    ...
    #[test]
    fn test_session_persistence_config_creation_succeeds() {
    ...
    #[test]
    fn test_create_resumption_config_none_succeeds() {
    ...
    #[test]
    fn test_create_resumption_config_with_persistence_succeeds() {
...
mod connection_config {
    ...
    #[test]
    fn test_server_config_builder_classic_succeeds() {
    ...
    #[test]
    fn test_server_config_builder_hybrid_succeeds() {
    ...
    #[test]
    fn test_server_config_builder_pq_succeeds() {
    ...
    #[test]
    fn test_client_config_builder_with_early_data_succeeds() {
    ...
    #[test]
    fn test_config_with_pq_kx_disabled_succeeds() {
        let config = Tls13Config::hybrid().with_pq_kx(false);
        assert!(!config.use_pq_kx);
    }

    #[test]
    fn test_config_with_alpn_protocols_succeeds() {
    ...
    #[test]
    fn test_config_with_max_fragment_size_has_correct_size() {
    ...
    #[test]
    fn test_tls_config_with_fallback_disabled_succeeds() {
    ...
    #[test]
    fn test_tls_config_with_resumption_disabled_succeeds() {
...
mod connection_state_machine {
    ...
    #[test]
    fn test_handshake_stats_clone_succeeds() {
        let stats = HandshakeStats::default();
...
mod key_exchange {
    ...
    #[test]
    fn test_ml_kem_kex_info_hybrid_succeeds() {
    ...
    #[test]
    fn test_classical_kex_x25519_succeeds() {
    ...
    fn test_pq_availability_succeeds() {
        assert!(latticearc::tls::pq_key_exchange::is_pq_available());
    }

    #[test]
    fn test_custom_hybrid_availability_succeeds() {
        assert!(latticearc::tls::pq_key_exchange::is_custom_hybrid_available());
    }
}
...
mod configuration {
    ...
    #[test]
    fn test_tls_version_negotiation_tls13_only_succeeds() {
    ...
    #[test]
    fn test_tls_version_negotiation_tls12_and_tls13_succeeds() {
        let config = TlsConfig::new()
    ...
    #[test]
    fn test_alpn_protocol_selection_succeeds() {
    ...
    #[test]
    fn test_sni_configuration_succeeds() {
    ...
    #[test]
    fn test_max_fragment_length_extension_has_correct_size() {
        let config = TlsConfig::new().with_max_fragment_size(4096);
        assert_eq!(config.max_fragment_size, Some(4096));
    }

    #[test]
    fn test_max_fragment_length_default_has_correct_size() {
        let config = TlsConfig::new();
        assert!(config.max_fragment_size.is_none()); // Default is 16KB
    }

    #[test]
    fn test_certificate_verification_none_succeeds() {
    ...
    #[test]
    fn test_certificate_verification_optional_succeeds() {
    ...
    #[test]
    fn test_certificate_verification_required_succeeds() {
    ...
    #[test]
    fn test_client_auth_config_succeeds() {
    ...
    #[test]
    fn test_cipher_suites_classic_succeeds() {
        let suites = get_cipher_suites(TlsMode::Classic);
        assert_eq!(suites.len(), 3);
    }

    #[test]
    fn test_cipher_suites_hybrid_succeeds() {
        let suites = get_cipher_suites(TlsMode::Hybrid);
        assert_eq!(suites.len(), 3);
    }

    #[test]
    fn test_cipher_suites_pq_succeeds() {
        let suites = get_cipher_suites(TlsMode::Pq);
        assert_eq!(suites.len(), 2);
    }

    #[test]
    fn test_config_validation_valid_succeeds() {
        let config = TlsConfig::new()
            .with_min_protocol_version(rustls::ProtocolVersion::TLSv1_3)
            .with_max_protocol_version(rustls::ProtocolVersion::TLSv1_3);
    ...
    #[test]
    fn test_verify_config_valid_hybrid_succeeds() {
        let config = Tls13Config::hybrid();
...
mod error_scenarios {
    ...
    #[test]
    fn test_connection_refused_error_fails() {
    ...
    #[test]
    fn test_connection_timeout_error_fails() {
    ...
    #[test]
    fn test_connection_reset_error_fails() {
    ...
    #[test]
    fn test_unexpected_eof_error_fails() {
    ...
    #[test]
    fn test_error_severity_levels_fails() {
    ...
    #[test]
    fn test_operation_phase_initialization_succeeds() {
    ...
    #[test]
    fn test_error_recoverability_fails() {
        let io_err = std::io::Error::new(std::io::ErrorKind::ConnectionReset, "test");
        let tls_err = TlsError::from(io_err);
...
mod policy_engine {
    ...
    #[test]
    fn test_recommend_mode_web_server_succeeds() {
...
mod circuit_breaker {
    ...
    #[test]
    fn test_circuit_breaker_allows_request_when_closed_succeeds() {
        let breaker = CircuitBreaker::new(5, Duration::from_secs(60));
    ...
    #[test]
    fn test_circuit_breaker_success_resets_failure_count_fails() {
        let breaker = CircuitBreaker::new(5, Duration::from_secs(60));
...
mod retry_policy {
    ...
    #[test]
    fn test_retry_policy_custom_succeeds() {
    ...
    #[test]
    fn test_backoff_increases_with_attempts_succeeds() {
    ...
    #[test]
    fn test_backoff_respects_max_succeeds() {
...
mod config_conversion {
    ...
    #[test]
    fn test_tls13_config_from_tls_config_hybrid_succeeds() {
        let config = TlsConfig::new();
    ...
    #[test]
    fn test_tls13_config_from_tls_config_classic_succeeds() {
    ...
    #[test]
    fn test_tls13_config_from_tls_config_pq_succeeds() {
        let mut config = TlsConfig::new();
    ...
    #[test]
    fn test_tls13_config_inherits_alpn_succeeds() {
    ...
    #[test]
    fn test_tls13_config_inherits_early_data_succeeds() {
    ...
    #[test]
    fn test_tls13_config_inherits_fragment_size_has_correct_size() {
        let config = TlsConfig::new().with_max_fragment_size(4096);
        let tls13_config = Tls13Config::from(&config);
...
mod use_cases {
    ...
    #[test]
    fn test_use_case_descriptions_is_documented() {
...
mod version_and_availability {
    ...
    fn test_pq_enabled_succeeds() {
        assert!(latticearc::tls::pq_enabled());
    }
...
mod scheme_selector {
    ...
    #[test]
    fn test_hybrid_schemes_succeeds() {
    ...
    #[test]
    fn test_default_kex_algorithms_succeeds() {
    ...
    #[test]
    fn test_select_hybrid_scheme_by_level_succeeds() {
    ...
    #[test]
    fn test_select_pq_scheme_by_level_succeeds() {
