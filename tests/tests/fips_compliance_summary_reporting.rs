//! FIPS validation-summary and compliance-report generation tests.
//!
//! Covers the `validation_summary` module's public types, summary
//! generation/aggregation, JSON/HTML report formatting, statistics
//! calculation, compliance-status determination, and the
//! `ComplianceReporter` report-generation methods.
