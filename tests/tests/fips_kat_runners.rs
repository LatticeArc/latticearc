...
mod runners {
    ...
    //!
    //! This module tests all public runner functions in the `latticearc_tests::validation::kat_tests::runners` module.
    ...
    use latticearc_tests::validation::kat_tests::runners::{
...
mod runners_extended {
    ...
    //!
    //! This module provides additional coverage for the `latticearc_tests::validation::kat_tests::runners` module.
    //! It focuses on:
    ...
    mod run_all_kats_tests {
        ...
        fn test_run_all_kats_pass_fail_summary_matches_expected() {
            ...
            assert_eq!(
                passed + failed,
                results.len(),
                "All results should be either passed or failed"
            );
        }
    }
        ...
        fn test_ed25519_keypair_with_empty_message_matches_expected() {
            let vector = Ed25519KatVector {
                ...
                seed: vec![
                    ...
                    0xec, 0x2c, 0xc5, 0x44, 0x49, 0xdc, 0x56, 0x27, 0x18, 0x2c, 0x28, 0xbd, 0x25,
                    0x0f, 0x1a, 0x8e, 0x6c, 0x4b, 0x8e,
                ],
    ...
    mod performance_extended_tests {
        ...
        fn test_run_all_kats_performance_matches_expected() {
            ...
            assert!(
                ...
                "All KATs should complete in under 60 seconds"
            );
        }
