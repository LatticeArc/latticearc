...
use crate::validation::kat_tests::types::*;
use crate::validation::nist_sp800_22::NistSp800_22Tester;
use anyhow::Result;
...
impl Fips140_3Validator {
    ...
    fn test_hash_functions() -> SelfTestResult {
        ...
        let expected_sha256 = [
            0x30, 0x94, 0x13, 0xf8, 0xaa, 0x4b, 0x01, 0xf2, 0x20, 0x79, 0xc5, 0xb1, 0x18, 0xe2,
            0x1a, 0x48, 0x31, 0x1c, 0x6f, 0xe2, 0x2a, 0x56, 0xbc, 0x66, 0x7a, 0xc1, 0xd2, 0xcd,
            0x91, 0xca, 0x87, 0xd7,
        ];

        let expected_sha3_256 = [
            0xef, 0xd5, 0x97, 0xfd, 0x73, 0xb0, 0x5a, 0xf4, 0xe1, 0x27, 0xe1, 0x4a, 0x11, 0x81,
            0x32, 0x8b, 0x20, 0x29, 0x22, 0x7e, 0x13, 0xe6, 0x3c, 0xd1, 0xa3, 0x93, 0x8a, 0x01,
            0x02, 0xe3, 0xb5, 0xda,
        ];
