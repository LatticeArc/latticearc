//! CAVP integration tests
#![allow(clippy::unwrap_used)]
#![allow(clippy::redundant_clone)]
#![allow(clippy::float_cmp)]

use crate::validation::cavp::pipeline::PipelineConfig;
use crate::validation::cavp::storage::CavpStorage;
use crate::validation::documentation::NistDocumentationGenerator;
...
fn test_cavp_framework_basic_functionality() {
    ...
    let test_result = crate::validation::cavp::CavpTestResult::new(
        "test-001".to_string(),
        algorithm.clone(),
        ...
        crate::validation::cavp::CavpTestMetadata {
            environment: crate::validation::cavp::TestEnvironment {
                os: "linux".to_string(),
            ...
            configuration: crate::validation::cavp::TestConfiguration {
                iterations: 1,
...
fn test_cavp_compliance_generator_creation() {
    ...
    let test_result = crate::validation::cavp::CavpTestResult::new(
        ...
        crate::validation::cavp::CavpTestMetadata::default(),
    );

    let mut batch =
        crate::validation::cavp::CavpBatchResult::new("batch-002".to_string(), algorithm);
...
fn test_nist_documentation_generator_creation() {
    ...
    let algorithm = crate::validation::cavp::CavpAlgorithm::MlDsa { variant: "65".to_string() };

    let test_metadata = crate::validation::cavp::CavpTestMetadata {
        environment: crate::validation::cavp::TestEnvironment {
            os: "linux".to_string(),
            arch: "x86_64".to_string(),
            rust_version: "1.70.0".to_string(),
        ...
        vector_version: "1.0".to_string(),
        implementation_version: "1.0.0".to_string(),
        configuration: crate::validation::cavp::TestConfiguration::default(),
    };
    ...
    let mut batch =
        crate::validation::cavp::CavpBatchResult::new("batch-003".to_string(), algorithm);
    batch.add_test_result(test_result);

    let compliance_generator = crate::validation::cavp::CavpComplianceGenerator::new();
...
fn test_cavp_framework_error_handling() {
    ...
    let failed_result = crate::validation::cavp::CavpTestResult::failed(
        "test-fail".to_string(),
        algorithm.clone(),
...
fn test_cavp_algorithm_enumeration() {
    ...
    let fndsa_512 = crate::validation::cavp::CavpAlgorithm::FnDsa { variant: "512".to_string() };
    let hybrid_kem = crate::validation::cavp::CavpAlgorithm::HybridKem;
