...
impl NistDocumentationGenerator {
    ...
    fn format_test_result(result: &crate::validation::cavp::compliance::TestResult) -> String {
        match result {
            crate::validation::cavp::compliance::TestResult::Passed => "PASSED".to_string(),
            crate::validation::cavp::compliance::TestResult::Failed(reason) => {
                format!("FAILED - {}", reason)
            }
            crate::validation::cavp::compliance::TestResult::Skipped(reason) => {
                format!("SKIPPED - {}", reason)
            }
            crate::validation::cavp::compliance::TestResult::Error(reason) => {
                format!("ERROR - {}", reason)
            }
        }
    }
